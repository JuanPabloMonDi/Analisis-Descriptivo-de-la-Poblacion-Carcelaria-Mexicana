...
varCualitativas<-setdiff(colnames(Tabla1),c("ID_PER","NOM_ENT","CAR_PERSONAS_CELDA" , "CATEGORIAS_EDAD_CONSUMO_TABACO","CATEGORIAS_EDAD_CONSUMO_ALCOHOL", "CATEGORIAS_EDAD_CONSUMO_MARIHUANA", "CATEGORIAS_EDAD_CONSUMO_INHALABLES","CATEGORIAS_EDAD_CONSUMO_LSD", "CATEGORIAS_EDAD_CONSUMO_HONGOS", "CATEGORIAS_EDAD_CONSUMO_COCAINA" , "CATEGORIAS_EDAD_CONSUMO_PASTA_COCAINA","CATEGORIAS_EDAD_CONSUMO_CRACK","CATEGORIAS_EDAD_CONSUMO_HEROINA", "CATEGORIAS_EDAD_CONSUMO_CHOCHOS","CATEGORIAS_EDAD_CONSUMO_TRANQUILIZANTES","CATEGORIAS_EDAD_CONSUMO_ANFETAMINAS", "CATEGORIAS_TIEMPO_RECLUIDO", "CATEGORIAS_TIEMPO_PROCESO" ,varCuantitativas))
...
#ORIENT_SEXUAL 67:72
#COVID 73:76
#CONSIDERO_SUICIDIO 77:80
#DISC_VISUAL 81:84
#DISC_AUDITIVA 85:88
#DISC_MOTRIZ 89:92
#CONSUMO_TABACO  93:96
#CONSUMO_ALCOHOL 97:100
#CONSUMO_MARIHUANA 101:104
#CONSUMO_INHALABLES 105:108
#CONSUMO_LSD 109:112
#CONSUMO_HONGOS 113:116
#CONSUMO_COCAINA 117:120
#CONSUMO_PASTA_COCAINA 121:124
#CONSUMO_CRACK 125:128
#CONSUMO_HEROINA 129:132
#CONSUMO_CHOCHOS 133:136
#CONSUMO_TRANQUILIZANTES 137:140
#CONSUMO_ANFETAMINAS 141:144
#VIVE_CON 145:154
#TRABAJO 154:158
#PODIA_COMER 159:162
#DEUDA  163:166
#SALARIO_MES_ANTERIOR 167:175
#MOTIVO_DETENCION 176:182
#TIEMPO_DEL_DET 183:190
#INTENTO_SOBORNO 191: 194
#DECLARACION CULPABLE 195:207
#INTENTO_SOBORNO_JUICIO 208:211
#CELDA_VENTANAS 212:215
#CELDA_AGUA_POTABLE 216:219
#CELDA_DRENAJE 220:223
#CELDA_LUZ 224:227
#CELDA_DUCHA 228: 231
#CELDA_SANITARIO 232: 235
#CELDA_SERVICIO_MEDICO 236:240
#CELDA_ALIMENTOS 241:244
#CARCEL_EJERCICIO 245:248
#CARCEL_LECTURA 249:252
#CARCEL_RELIGION 253: 256
#CARCEL_LLAMADAS 257:260
#CARCEL_ESTUDIO 261:264
#CARCEL_VISITA 265: 268
#CELDA_SEGURIDAD 269: 272
#CARCEL_SEGURIDAD 273:276
#SENTENCIADO_ANTES 277:280
#VIVIO_MADRE_ADOLESCENCIA 281:284
#VIVIO_PADRE_ADOLESCENCIA 285:288
#SALIDA_VIVIENDA 289:292
#SALIDA_EMPLEO 293:296
#SALIDA_ESTUDIO 297:300
#SALIDA_AMIGOS 301:304
#SALIDA_FAMILIA 305:308
#SALIDA_REINCORPORACION 309:312
#COLOR_PIEL 313:324
```
...
#| echo: false
test_cos<-cbind(sup$tv, sup$cos2)
kable(head(test_cos[43:60,]), digits = 3)
```

```{r}
#| echo: false
plot(acp, Tcol = FALSE, ucal = 100, cex.row = 0,
     xlim = c(min(sup$coor[43:60,]-0.2),1), ylim = c(-1, 1), plot.axes = FALSE)
#s.arrow(acp$co, add.plot = TRUE, boxes = F)
points(sup$coor[43:60,], col = 6, pch = 16)
text(sup$coor[43:60,], labels = rownames(sup$coor[43:60,]),
     col = 6, pos = 1, font = 3, srt=-45)
```
...
#| echo: false
test_cos<-cbind(sup$tv, sup$cos2)
kable(head(test_cos[97:100,]), digits = 3)
```

```{r}
#| echo: false
plot(acp, Tcol = FALSE, ucal = 100, cex.row = 0,
     xlim = c(min(sup$coor[97:100,]-0.2),1), ylim = c(-1, 1), plot.axes = FALSE)
#s.arrow(acp$co, add.plot = TRUE, boxes = F)
points(sup$coor[97:100,], col = 6, pch = 16)
text(sup$coor[97:100,], labels = rownames(sup$coor[97:100,]),
     col = 6, pos = 1, font = 3, srt=-45)
```
...
#| echo: false
test_cos<-cbind(sup$tv, sup$cos2)
kable(head(test_cos[101:104,]), digits = 3)
```

```{r}
#| echo: false
plot(acp, Tcol = FALSE, ucal = 100, cex.row = 0,
     xlim = c(min(sup$coor[101:104,]-0.2),1), ylim = c(-1, 1), plot.axes = FALSE)
#s.arrow(acp$co, add.plot = TRUE, boxes = F)
points(sup$coor[101:104,], col = 6, pch = 16)
text(sup$coor[101:104,], labels = rownames(sup$coor[101:104,]),
     col = 6, pos = 1, font = 3, srt=-45)
```
...
#| echo: false
test_cos<-cbind(sup$tv, sup$cos2)
kable(head(test_cos[167:175,]), digits = 3)
```

```{r}
#| echo: false
plot(acp, Tcol = FALSE, ucal = 100, cex.row = 0,
     xlim = c(min(sup$coor[167:175,]-0.2),1), ylim = c(-1, 1), plot.axes = FALSE)
#s.arrow(acp$co, add.plot = TRUE, boxes = F)
points(sup$coor[167:175,], col = 6, pch = 16)
text(sup$coor[167:175,], labels = rownames(sup$coor[167:175,]),
     col = 6, pos = 1, font = 3, srt=-45)
```
...
#| echo: false
test_cos<-cbind(sup$tv, sup$cos2)
kable(head(test_cos[159:162,]), digits = 3)
```

```{r}
#| echo: false
plot(acp, Tcol = FALSE, ucal = 100, cex.row = 0,
     xlim = c(min(sup$coor[159:162,]-0.2),1), ylim = c(-1, 1), plot.axes = FALSE)
#s.arrow(acp$co, add.plot = TRUE, boxes = F)
points(sup$coor[159:162,], col = 6, pch = 16)
text(sup$coor[159:162,], labels = rownames(sup$coor[159:162,]),
     col = 6, pos = 1, font = 3, srt=-45)
```
...
#| echo: false
test_cos<-cbind(sup$tv, sup$cos2)
kable(head(test_cos[163:166,]), digits = 3)
```

```{r}
#| echo: false
plot(acp, Tcol = FALSE, ucal = 100, cex.row = 0,
     xlim = c(min(sup$coor[163:166,]-0.2),1), ylim = c(-1, 1), plot.axes = FALSE)
#s.arrow(acp$co, add.plot = TRUE, boxes = F)
points(sup$coor[163:166,], col = 6, pch = 16)
text(sup$coor[163:166,], labels = rownames(sup$coor[163:166,]),
     col = 6, pos = 1, font = 3, srt=-45)
```
...
#| echo: false
test_cos<-cbind(sup$tv, sup$cos2)
kable(head(test_cos[277:280,]), digits = 3)
```

```{r}
#| echo: false
plot(acp, Tcol = FALSE, ucal = 100, cex.row = 0,
     xlim = c(min(sup$coor[277:280,]-0.2),1), ylim = c(-1, 1), plot.axes = FALSE)
#s.arrow(acp$co, add.plot = TRUE, boxes = F)
points(sup$coor[277:280,], col = 6, pch = 16)
text(sup$coor[277:280,], labels = rownames(sup$coor[277:280,]),
     col = 6, pos = 1, font = 3, srt=-45)
```
...
#| echo: false
test_cos<-cbind(sup$tv, sup$cos2)
kable(head(test_cos[176:182,]), digits = 3)
```

```{r}
#| echo: false
plot(acp, Tcol = FALSE, ucal = 100, cex.row = 0,
     xlim = c(min(sup$coor[176:182,]-0.2),1), ylim = c(-1, 1), plot.axes = FALSE)
#s.arrow(acp$co, add.plot = TRUE, boxes = F)
points(sup$coor[176:182,], col = 6, pch = 16)
text(sup$coor[176:182,], labels = rownames(sup$coor[176:182,]),
     col = 6, pos = 1, font = 3, srt=-45)
```
...
#| echo: false
test_cos<-cbind(sup$tv, sup$cos2)
kable(head(test_cos[273:276,]), digits = 3)
```

```{r}
#| echo: false
plot(acp, Tcol = FALSE, ucal = 100, cex.row = 0,
     xlim = c(min(sup$coor[273:276,]-0.2),1), ylim = c(-1, 1), plot.axes = FALSE)
#s.arrow(acp$co, add.plot = TRUE, boxes = F)
points(sup$coor[273:276,], col = 6, pch = 16)
text(sup$coor[273:276,], labels = rownames(sup$coor[273:276,]),
     col = 6, pos = 1, font = 3, srt=-45)
```
...
#| echo: false
test_cos<-cbind(sup$tv, sup$cos2)
kable(head(test_cos[261:264,]), digits = 3)
```

```{r}
#| echo: false
plot(acp, Tcol = FALSE, ucal = 100, cex.row = 0,
     xlim = c(min(sup$coor[261:264,]-0.2),1), ylim = c(-1, 1), plot.axes = FALSE)
#s.arrow(acp$co, add.plot = TRUE, boxes = F)
points(sup$coor[261:264,], col = 6, pch = 16)
text(sup$coor[261:264,], labels = rownames(sup$coor[261:264,]),
     col = 6, pos = 1, font = 3, srt=-45)
```
...
#| echo: false
test_cos<-cbind(sup$tv, sup$cos2)
kable(head(test_cos[309:312,]), digits = 3)
```

```{r}
#| echo: false
plot(acp, Tcol = FALSE, ucal = 100, cex.row = 0,
     xlim = c(min(sup$coor[309:312,]-0.2),1), ylim = c(-1, 1), plot.axes = FALSE)
#s.arrow(acp$co, add.plot = TRUE, boxes = F)
points(sup$coor[309:312,], col = 6, pch = 16)
text(sup$coor[309:312,], labels = rownames(sup$coor[309:312,]),
     col = 6, pos = 1, font = 3, srt=-45)
```
...
# El parámetro nf indica cuantos ejes voy a conservar
valp <- t(inertia(acp3)$tot.inertia) # valores propios
kable(valp, digits = 3)
```
...
fviz_eig(res.pca3,addlabels=T,ylim=c(0,35),ylab = "Porcentaje de varianza explicada",xlab="Eje",main="")
...
plot.PCA(res.pca,choix='var',habillage = 'contrib',cex=0.6,cex.main=0.9,cex.axis=0.9,axes = c(6,1))
#fviz_pca_var(res.pca2,axes=c(1,2), col.var = "contrib", gradient.cols = c("#FFFFFF","#E7B800","#08306B"))
```
...
plot.PCA(res.pca,choix='var',habillage = 'contrib',cex=0.6,cex.main=0.9,cex.axis=0.9,axes = c(6,2))
...
```{r}
#| title: ACP 4 Ejes 6-3
#| echo: false

plot.PCA(res.pca,choix='var',habillage = 'contrib',cex=0.6,cex.main=0.9,cex.axis=0.9,axes = c(6,3))
#fviz_pca_var(res.pca2,axes=c(1,3),col.var = "contrib",gradient.cols = c("#FFFFFF", "#E7B800","#08306B"))
```
:::
...
fviz_pca_ind(res.pca,
             axes = c(6,2),
             geom.ind = "point", # show points only (nbut not "text")
             col.ind = Tabla1$COLOR_PIEL, # color by groups
#             palette = c("#00AFBB", "#E7B800","#FC4E07","red","black"),
             addEllipses = TRUE, # Concentration ellipses
             legend.title = "Groups"
             )
